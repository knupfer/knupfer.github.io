...
$$ H_{max} = - 0.5 \cdot \log_2{0.5} - 0.5 \cdot \log_2{0.5} = 1 bit $$
...
gibt es eine maximale Entropie von $H_{max} = - \log_2{0.25} = 2 bits$. Somit kann man einen Test auch um $R/2$ solcher
